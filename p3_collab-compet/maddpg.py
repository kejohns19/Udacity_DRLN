...
class MADDPG:
    ...
    def act(self, obs_all_agents, noise=0.0, rand=0.0, eval_only=False):
        """get actions from all agents in the MADDPG object"""
        actions = [agent.act(obs, noise, rand, eval_only) for agent, obs in zip(self.maddpg_agent, obs_all_agents)]
        return actions
