...
class MADDPG:
    def __init__(self, in_actor, hidden_in_actor, hidden_out_actor, out_actor, in_critic, hidden_in_critic, hidden_out_critic, lr_actor=1.0e-5, lr_critic=1.0e-5, discount_factor=0.99, tau=1.0e-3):
